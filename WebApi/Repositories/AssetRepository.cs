...
public class AssetRepository : IAssetRepository
{
    ...
    public async Task<Asset> GetAsset(int id)
    {
        ...
        .Include(a => a.Assignments.Where(s => s.State.Equals(AssignmentState.Accepted) && s.IsInProgress == false)).ThenInclude(a => a.AssignTo)
        .Include(a => a.Assignments.Where(s => s.State.Equals(AssignmentState.Accepted) && s.IsInProgress == false)).ThenInclude(a => a.AssignedBy)
